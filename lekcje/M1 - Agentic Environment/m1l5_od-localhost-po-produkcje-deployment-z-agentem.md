...
![Obraz 1](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/0b3ca60086f358d95f80636a14ade70e1b253500cbc900dc7f365a9ef101dc0c.jpg)
...
![Obraz 2](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/56b8c157befa8962b8cc30fadf96ee9c7e64701339adc038da935a7de879cf8c.png)
...
W preworku [\[4.1\]](https://platforma.przeprogramowani.pl/courses/10xdevs-foundations/pl/14) Cloudflare jest wymieniany jako rekomendowana ścieżka dla projektu szkoleniowego, który chcesz odtwarzać 1:1 z naszych lekcji - przystępny pricing, dobrze udokumentowane SDK, sensowne wsparcie dla agentów.
...
![Obraz 3](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/3d2dbe82763c080a7529c22b1a97d139ee54be30ec50c1dfc528d0ae0990f32b.png)
...
![Obraz 4](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/b1455c97b75fa4930ece80d8857822eb451b98c9bc3bf2f1a4770a3809972565.png)
...
Drugi powód to możliwość powrotu do decyzji po kilku miesiącach. Jeśli wymagania projektu się zmienią, masz w repo zapis daty, rozważanych opcji i uzasadnienia wyboru. Możesz sprawdzić, które założenia nadal obowiązują. Podobną rolę pełni **Architecture Decision Record (ADR)**, czyli zapis decyzji architektonicznej. Więcej o nim przeczytasz [pod tym linkiem](https://martinfowler.com/bliki/ArchitectureDecisionRecord.html).
...
![Obraz 5](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/94a8a91c4a422c11bc494783f65c0203bf56fdc3cb23375a72b96cc556bf7eac.png)
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1191889944" title="Odtwarzacz wideo Vimeo" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"></iframe></div>
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1192705068" title="Odtwarzacz wideo Vimeo" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"></iframe></div>
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1192705069" title="Odtwarzacz wideo Vimeo" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;"></iframe></div>
...
W preworku [\[2.1\]](https://platforma.przeprogramowani.pl/courses/10xdevs-foundations/pl/04) mówiliśmy, że terminal (nie tylko agentowy, ale po prostu powłoka systemowa) to uniwersalne środowisko dla wielu narzędzi - wszystko, co da się wykonać w terminalu, agent też potrafi wykonać. To pierwsza ścieżka **agentic operability**: dajesz agentowi narzędzia takie jak **wrangler**, **gh**, **npm**, **psql**, agent woła je przez Bash, zbiera output, podejmuje kolejne decyzje.
...
![Obraz 6](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/691ff6519246c8903efd7ff4d4ea6bb6fb5508ae27992d8791e8bb591ab9eea7.png)
...
![Obraz 7](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/af40565b6b3dd473ea4c889a3073433332981b8b9207c447bb75ac7cc0577d83.png)

Po konfiguracji serwera, twojego agenta możesz zapytać np. tak: **Kiedy był ostatni deployment projektu \<nazwa>? Wykorzystaj MCP** - agent woła odpowiednie narzędzie MCP, dostaje strukturalną odpowiedź, prezentuje ci wynik (na przykładzie jednego z naszych projektów - opanuj-ai).

![Obraz 8](https://images.przeprogramowani.pl/cms/01302189-eb98-4767-9f50-7a45d1a0a6db/f578b14c3aed0a76caba2cfa2afe19fbbc1922e981e200488d5d13c811234f4d.png)
...
- **wrangler pages secret list --project-name 10xcards** - lista nazw sekretów skonfigurowanych w projekcie. Wartości nie zobaczysz, ale od razu wiadomo, czy np. **JWT\_SECRET** jest na miejscu, zanim ruszysz z debugowaniem.
